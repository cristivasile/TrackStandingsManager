...
### Supported Platforms
This app will only run on Desktop PCs running a Microsoft Windows version compatible with .NET 5. **To avoid visual bugs**, the "size of text, apps and other items" needs to be set to 100% in Display Settings on Windows 10 (for now).
